...
func SendWelcomeEmail(RecipientEmail string, RecipientName string, Body string) bool {
	messagesInfo := []mailjet.InfoMessagesV31{
		mailjet.InfoMessagesV31{
			...
			<body>
				<center>
					<img src="https://user-images.githubusercontent.com/26124625/104884138-dd1e2a80-598b-11eb-8b8e-bb2a23db022e.jpg" style=" height:auto; width: 400px; border-radius: 25px;"/>
					<div style="border: 1px solid grey; border-radius: 25px; background:lightgrey; margin:10px; width: 400px; padding:10px;">
						<h1> Glad to have you onboard! </h1>
						<p> Thanks for registering with <b> Library </b> , you are just one step away from being a member.
							<hr>
							For security purpose, we would like you to verify your email. <br> Click on the button below to verify!
							<br>
							<br>
							<button	type="box" 
								style="background:blue; border:1px solid white; font-size: 16px; border-radius: 10px; padding:5px; text-align: center;"
								> 
									<a href="` + Body + `" style="color:white; margin:5px 15px; text-decoration:none; font-weight:bold " > VERIFY </a>
							</button>
							<br> <br>
